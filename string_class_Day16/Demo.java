...
//		 System.out.println(s1==s2); //both ref variables are pointing to the same object
//		 System.out.println(s1.equals(s2)); //comparing values as equals() is already overridden

//		 s1=s1+"world"; //heap area, previous object gets deleted and new object in heap points to this
